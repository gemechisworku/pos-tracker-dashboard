...
class DistrictAdminView extends StatefulWidget {
  final MyUser myUser;

  const DistrictAdminView({super.key, required this.myUser});
  @override
  State<DistrictAdminView> createState() => _DistrictAdminViewState(myUser);
}

class _DistrictAdminViewState extends State<DistrictAdminView> {
  final MyUser myUser;
  List<String> typeList = ['Select workplace', 'District','Branch'];
  List<String> tempList = [];
  List<String> merchantsList = [];

  _DistrictAdminViewState(this.myUser);
          ...
          children: [
            ...
            StreamBuilder(
              stream: FirebaseFirestore.instance
                  .collection('location')
                  .where('district', isEqualTo: myUser.district)
                  .get()
                  .asStream(),
        ...
        onTap: () {
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => MerchantTerminal(myUser: myUser,
                  merchantName: item, distName: myUser.district)));
        },
      ),
    );
  }
